...
std::string TextGeometryExtensionPy::representation(void) const
{
    ...
    bool override = getTextGeometryExtensionPtr()->isShapeOverrideEnabled();
...
int TextGeometryExtensionPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!", &PyBool_Type, &val)) {
        this->getTextGeometryExtensionPtr()->setShapeOverrideEnabled( PyObject_IsTrue(val) ? true : false);
        return 0;
    }
...
{
    return Py::Boolean(this->getTextGeometryExtensionPtr()->isShapeOverrideEnabled());
}

void TextGeometryExtensionPy::setShapeOverrideEnabled(Py::Boolean value)
{
    this->getTextGeometryExtensionPtr()->setShapeOverrideEnabled(value);
}
