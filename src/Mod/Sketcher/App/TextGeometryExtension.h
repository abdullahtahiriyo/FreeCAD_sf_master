...
#include <Mod/Part/App/EnhancedShapeGeometryExtension.h>
...
public:
    ...
    inline bool isShapeOverrideEnabled() const {return shapeOverride;}
    inline void setShapeOverrideEnabled(bool shapeoverride) {shapeOverride = shapeoverride;}
