...
using DrawSketchHandlerOffsetBase =
    DrawSketchControllableHandler<DrawSketchHandlerOffsetController>;

class DrawSketchHandlerOffset: public DrawSketchHandlerOffsetBase
{
    friend DrawSketchHandlerOffsetController;
...
template<>
auto DrawSketchHandlerOffsetController::getState(int labelindex) const
{
    switch (labelindex) {
...
template<>
void DrawSketchHandlerOffsetController::configureToolWidget()
{
...
template<>
void DrawSketchHandlerOffsetController::adaptDrawingToOnViewParameterChange(int labelindex,
                                                                            double value)
{
    switch (labelindex) {
        case OnViewParameter::First: {
...
template<>
void DrawSketchHandlerOffsetController::adaptDrawingToCheckboxChange(int checkboxindex, bool value)
{
...
template<>
void DrawSketchHandlerOffsetController::adaptParameters(Base::Vector2d onSketchPos)
{
...
template<>
void DrawSketchHandlerOffsetController::doChangeDrawSketchHandlerMode()
{
    switch (handler->state()) {
        case SelectMode::SeekFirst: {
            if (onViewParameters[OnViewParameter::First]->isSet) {
