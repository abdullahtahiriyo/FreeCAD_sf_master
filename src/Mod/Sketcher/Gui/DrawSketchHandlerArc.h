...
void DSHArcController::configureToolWidget()
{
    ...
    if (handler->constructionMethod() == DrawSketchHandlerArc::ConstructionMethod::ThreeRim) {
        ...
        onViewParameters[OnViewParameter::Third]->setLabelType(Gui::SoDatumLabel::RADIUS);
        onViewParameters[OnViewParameter::Fourth]->setLabelType(Gui::SoDatumLabel::ANGLE);
        onViewParameters[OnViewParameter::Fifth]->setLabelType(Gui::SoDatumLabel::ANGLE);
    }
}
        ...
        case SelectMode::SeekThird: {
            if (handler->constructionMethod() == DrawSketchHandlerArc::ConstructionMethod::Center) {
                if (onViewParameters[OnViewParameter::Fifth]->isSet) {
                    ...
                    if (fmod(arcAngle, 2 * M_PI) < Precision::Confusion()) {
                        unsetOnViewParameter(onViewParameters[OnViewParameter::Fifth].get());
                        return;
                    }
                    onSketchPos.x = handler->centerPoint.x
                        + cos((handler->startAngle + arcAngle)) * handler->radius;
                    onSketchPos.y = handler->centerPoint.y
                        + sin((handler->startAngle + arcAngle)) * handler->radius;
                }
            }
            else {
                if (onViewParameters[OnViewParameter::Fifth]->isSet) {
    ...
    switch (handler->state()) {
        ...
        case SelectMode::SeekSecond: {
            if (handler->constructionMethod() == DrawSketchHandlerArc::ConstructionMethod::Center) {
                ...
                if (!onViewParameters[OnViewParameter::Third]->isSet) {
                    onViewParameters[OnViewParameter::Third]->setSpinboxValue(handler->radius);
                }
        ...
        case SelectMode::SeekThird: {
            if (handler->constructionMethod() == DrawSketchHandlerArc::ConstructionMethod::Center) {
                ...
                if (!onViewParameters[OnViewParameter::Fifth]->isSet) {
                    onViewParameters[OnViewParameter::Fifth]->setSpinboxValue(range,
                                                                              Base::Unit::Angle);
                }
                ...
                if (!onViewParameters[OnViewParameter::Fifth]->isSet) {
                    onViewParameters[OnViewParameter::Fifth]->setSpinboxValue(onSketchPos.x);
                }

                if (!onViewParameters[OnViewParameter::Sixth]->isSet) {
                    onViewParameters[OnViewParameter::Sixth]->setSpinboxValue(onSketchPos.y);
                }
