...
public:
    ...
    void initNCheckbox(int ncheckbox);
    ...
    bool isCheckboxPref(int checkboxindex);
    void setCheckboxPref(int checkboxindex, std::string prefEntry);
    void setCheckboxPrefEntry(int checkboxindex, std::string prefEntry);
    ...
    boost::signals2::connection registerCheckboxCheckedChanged(F2&& f) {
        return signalCheckboxCheckedChanged.connect(std::forward<F2>(f));
    }
