...
void InformationOverlayCoinConverter::calculate(const Part::Geometry * geometry) {
...
void InformationOverlayCoinConverter::addUpdateNode(const Result & result) {
...
template < InformationOverlayCoinConverter::CalculationType calculation >
bool InformationOverlayCoinConverter::isVisible() {
    if constexpr ( calculation == CalculationType::BSplineDegree ) {
...
template < typename Result >
void InformationOverlayCoinConverter::setPolygon(const Result & result, SoLineSet *polygonlineset, SoCoordinate3 *polygoncoords) {
...
template < int line = 1 >
void InformationOverlayCoinConverter::setText(const std::string & string, SoText2 * text) {
...
template < typename Result >
void InformationOverlayCoinConverter::clearCalculation(Result & result) {
...
template < typename Result>
void InformationOverlayCoinConverter::addNode(const Result & result) {
