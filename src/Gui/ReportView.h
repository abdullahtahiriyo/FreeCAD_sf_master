...
public:
    enum Paragraph {
        ...
        Error            = 2, /**< Error text */
        LogText          = 3,  /**< Log text */
        CriticalMessage  = 4, /**< critical text */
    };
...
public:
     ...
     * @see ReportOutput::CriticalMessage
     */
     ...
     * Sets the text color to  \a col.
     */
    void setCriticalTextColor( const QColor& col );

private:
    /** @name for internal use only */
    //@{
    Paragraph type;
    QColor txtCol, logCol, warnCol, errCol, criticalTxtCol;
    //@}
};
...
public Q_SLOTS:
    ...
    /** Toggles whether to show report view on normal messages*/
    void onToggleShowReportViewOnCriticalMessage();
