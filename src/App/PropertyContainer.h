...
protected:
  ...
  // Returns the names of properties that despite having corresponding name and type should be specially
  // handled by the container
  virtual std::vector<std::string> getSpecialHandlingPropertyNames() const;

  virtual void handleChangedPropertyName(Base::XMLReader &reader, const char * TypeName, const char *PropName);
  virtual void handleChangedPropertyType(Base::XMLReader &reader, const char * TypeName, Property * prop);
  virtual void handleSpecialProperty(Base::XMLReader &reader, const char * TypeName, const char *PropName);
